...
class PrerequisiteResolver:
    ...
    def get_all_prerequisites(self, skill_id):
        ...
        # 1. Build Subgraph of Required Edges
        required_edges = [
        ...
        try:
            full_topo = list(nx.topological_sort(self.G))
        except nx.NetworkXUnfeasible:
            # Fallback if cycles exist (should be 0 in clean data)
            full_topo = list(self.G.nodes())
